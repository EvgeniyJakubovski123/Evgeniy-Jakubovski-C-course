<!DOCTYPE html>
<!-- saved from url=(0046)https://www.onlinegdb.com/online_c++_compiler# -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="./1.2_files/publishertag.prebid.js.download"></script><script src="./1.2_files/osd.js.download"></script><script type="text/javascript" async="" src="./1.2_files/localstore.js.download"></script><script type="text/javascript" src="./1.2_files/shares.json"></script><script type="text/javascript" src="./1.2_files/shares(1).json"></script><script type="text/javascript" src="./1.2_files/1.txt"></script><script type="text/javascript" src="./1.2_files/1(1).txt"></script><script type="text/javascript" src="./1.2_files/moatframe.js.download"></script>
    <title>Online C++ Compiler -  online editor</title>

    
    <meta name="description" content="OnlineGDB is online IDE with C++ compiler. Quick and easy way to compiler c++ program online. It supports g++ compiler for c++.">
    <meta name="keywords" content="online c++ compiler, execute c++ online, compile c++ code online, online c++ ide, compile c++ program online">
    ...
    <div class="split-pane-component " id="left-component" style="background-color: #125792;">
        <div style="background-color: #125792; padding:10px 0px 0px 0px">
          ...
          <ul class="nav nav-tabs nav-stacked text-center" style="background-color: #337ab7; border-bottom:1px solid #658a9e">
                ...
                <li id="navbar_project_title">1.2</li><li><a href="https://www.onlinegdb.com/">Create New Project</a></li>
...
<center>
    ...
    <script async="" type="text/javascript" src="./1.2_files/carbon.js.download" id="_carbonads_js"></script> 
...
<span style="float:none;clear:both">© 2016 - 2021 GDB Online</span>
</div>
        </footer>
    ...
    <div class="split-pane-component" id="right-component">
        ...
        <script src="./1.2_files/js-dos.js.download"></script>
        ...
        <div class="split-pane fixed-left" style="min-width: 1px;">
            <div class="split-pane-component" id="right-left-component" style="width: 1228px;">
                <div class="split-pane fixed-top" style="min-height: 6px;">
    ...
    <div id="title-bar" style="padding:0px 5px;min-width:900px">
        ...
        <div style="position:relative">
            ...
            <span class="col-sm-63" id="control-bar" style="float:left">
                <span id="project_title" class="hide">1.2</span>
...
<!--                  <option  value="c++11">C++ 11</option> -->
    ...
    <div id="multi_editor_container">
        <div style="clear:both; background-color:#757575;">
            <ul class="editor_file_tabs nav nav-pills">
                    ...
                    <li class="active">
                        <a href="https://www.onlinegdb.com/online_c++_compiler#editor_1" data-toggle="tab"><span class="filename">main.c</span>                   
                        </a>
                    </li>
        ...
        <div class="editor_text_panes tab-content clearfix">
            ...
            <div id="editor_1" class="tab-pane active editor ace_editor ace-idle-fingers ace_dark" style="position: absolute; width: 100%; top: 52px; bottom: 0px; font-size: medium;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; height: 18.4px; width: 8.797px; left: 98.985px; top: 165.6px;"></textarea><div class="ace_gutter"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 506.8px; width: 51px;"><div class="ace_gutter-cell " style="height: 18.4px;">1<span class="ace_fold-widget ace_start ace_open" style="height: 18.4px;"></span></div><div class="ace_gutter-cell " style="height: 18.4px;">2</div><div class="ace_gutter-cell " style="height: 18.4px;">3</div><div class="ace_gutter-cell " style="height: 18.4px;">4</div><div class="ace_gutter-cell " style="height: 18.4px;">5</div><div class="ace_gutter-cell " style="height: 18.4px;">6</div><div class="ace_gutter-cell " style="height: 18.4px;">7</div><div class="ace_gutter-cell " style="height: 18.4px;">8</div><div class="ace_gutter-cell " style="height: 18.4px;">9</div><div class="ace_gutter-cell " style="height: 18.4px;">10</div><div class="ace_gutter-cell " style="height: 18.4px;">11</div><div class="ace_gutter-cell " style="height: 18.4px;">12</div><div class="ace_gutter-cell " style="height: 18.4px;">13</div><div class="ace_gutter-cell " style="height: 18.4px;">14<span class="ace_fold-widget ace_start ace_open" style="height: 18.4px;"></span></div><div class="ace_gutter-cell " style="height: 18.4px;">15</div><div class="ace_gutter-cell " style="height: 18.4px;">16</div><div class="ace_gutter-cell " style="height: 18.4px;">17</div><div class="ace_gutter-cell " style="height: 18.4px;">18</div><div class="ace_gutter-cell " style="height: 18.4px;">19</div><div class="ace_gutter-cell " style="height: 18.4px;">20</div><div class="ace_gutter-cell " style="height: 18.4px;">21</div><div class="ace_gutter-cell " style="height: 18.4px;">22</div><div class="ace_gutter-cell " style="height: 18.4px;">23</div><div class="ace_gutter-cell " style="height: 18.4px;">24</div><div class="ace_gutter-cell " style="height: 18.4px;">25</div><div class="ace_gutter-cell " style="height: 18.4px;">26</div><div class="ace_gutter-cell " style="height: 18.4px;">27</div></div><div class="ace_gutter-active-line" style="top: 165.6px; height: 18.4px;"></div></div><div class="ace_scroller" style="left: 51px; right: 17px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 1160px; height: 506.8px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 707.76px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:18.399999618530273px;top:165.59999656677246px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line" style="height:18.399999618530273px"><span class="ace_comment ace_doc">/******************************************************************************</span></div><div class="ace_line" style="height:18.399999618530273px"></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_comment ace_doc">Welcome to GDB Online.</span></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_comment ace_doc">GDB online is an online compiler and debugger tool for C, C++, Python, Java, PHP, Ruby, Perl,</span></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_comment ace_doc">C#, VB, Swift, Pascal, Fortran, Haskell, Objective-C, Assembly, HTML, CSS, JS, SQLite, Prolog.</span></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_comment ace_doc">Code, Compile, Run and Debug online from anywhere in world.</span></div><div class="ace_line" style="height:18.399999618530273px"></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_comment ace_doc">*******************************************************************************/</span></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_keyword">#include</span><span class="ace_constant ace_other"> &lt;stdio.h&gt;</span></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_keyword">#include</span><span class="ace_constant ace_other"> &lt;math.h&gt;</span></div><div class="ace_line" style="height:18.399999618530273px"></div><div class="ace_line" style="height:18.399999618530273px"></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_storage ace_type">int</span> <span class="ace_identifier">main</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div><div class="ace_line" style="height:18.399999618530273px"><span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height:18.399999618530273px"></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">float</span> <span class="ace_identifier">x</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">10e-4</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">float</span> <span class="ace_identifier">y</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">23.33E5</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">float</span> <span class="ace_identifier">z</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">3.14158f</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">float</span> <span class="ace_identifier">t</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function ace_C99 ace_c">exp</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">double</span> <span class="ace_identifier">x1</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">10e-4</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">double</span> <span class="ace_identifier">y1</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">23.33E5</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">double</span> <span class="ace_identifier">z1</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">3.14158f</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">double</span> <span class="ace_identifier">t1</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function ace_C99 ace_c">exp</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">long</span> <span class="ace_storage ace_type">double</span> <span class="ace_identifier">x2</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">10e-4</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">long</span> <span class="ace_storage ace_type">double</span> <span class="ace_identifier">y2</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">23.33E5</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">long</span> <span class="ace_storage ace_type">double</span> <span class="ace_identifier">z2</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">3.14158f</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height:18.399999618530273px">    <span class="ace_storage ace_type">long</span> <span class="ace_storage ace_type">double</span> <span class="ace_identifier">t2</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function ace_C99 ace_c">exp</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="left: 47.985px; top: 165.6px; width: 8.797px; height: 18.4px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 22px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 920px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 51px; right: 17px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 1177px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>
    ...
    <div id="console-fadder" style="display: none;">
        <center><img src="./1.2_files/loading.gif"><img>
        <div class="msg-wrapper"><h4 class="msg">Compiling Program...</h4></div>
        </center>
    </div>
    <div id="console-title-bar">
        <ul class="nav nav-tabs nav-justified">
            <li class="tab-input active"><a data-toggle="tab" href="https://www.onlinegdb.com/online_c++_compiler#tab-stdin" aria-expanded="true">input</a></li>
            <li class="tab-stdout" style="display:none"><a data-toggle="tab" href="https://www.onlinegdb.com/online_c++_compiler#tab-stdout">stdout</a></li>
            <li class="tab-stderr" style="display: none;"><a data-toggle="tab" href="https://www.onlinegdb.com/online_c++_compiler#tab-stderr" aria-expanded="false">stderr</a></li>
            <li class="tab-debug" style="display:none"><a data-toggle="tab" href="https://www.onlinegdb.com/online_c++_compiler#tab-debug-console">Debug Console</a></li>
        </ul>
    </div>
    <div id="console-content" class="tab-content">
        <div id="tab-stdin" class="tab-pane fade active in" style="display: block;">
                ...
                <input type="radio" id="input_method_interactive" name="input_method" value="interactive" checked=""> Interactive Console
                    ...
                    <div id="ad_unit_bottom_wrapper">
                        <div id="ad_unit_bottom">
                            ...
                            <div id="bsa-zone_1573224210072-0_123456" data-google-query-id="CLf9j_GgofMCFdcbGAodaI8F2g"><div id="google_ads_iframe_/8691100/OnlineGDB_S2S_Leaderboard_BTF_0__container__" style="border: 0pt none; display: inline-block; width: 728px; height: 90px;"><iframe frameborder="0" src="./1.2_files/container.html" id="google_ads_iframe_/8691100/OnlineGDB_S2S_Leaderboard_BTF_0" title="3rd party ad content" name="" scrolling="no" marginwidth="0" marginheight="0" width="728" height="90" data-is-safeframe="true" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" data-google-container-id="1" style="border: 0px; vertical-align: bottom;" data-load-complete="true"></iframe></div></div>
            ...
            <div id="interactive-terminal-container" style="position:absolute; margin:0px;top:0px; bottom:0px; left:0px; right:0px;" class="col-sm-121"><div dir="ltr" class="terminal xterm" tabindex="0" role="document"><div class="xterm-viewport" style="background-color: rgb(0, 0, 0);"><div class="xterm-scroll-area" style="height: 368px;"></div></div><div class="xterm-screen" style="width: 1206px; height: 147px;"><div class="xterm-helpers"><textarea class="xterm-helper-textarea" aria-label="Terminal input" aria-multiline="false" autocorrect="off" autocapitalize="off" spellcheck="false" tabindex="0" style="left: 252.35px; top: 126px; width: 9.0125px; height: 18px; line-height: 18px; z-index: -5;"></textarea><span class="xterm-char-measure-element" aria-hidden="true" style="font-family: courier-new, courier, monospace; font-size: 15px;">W</span><div class="composition-view"></div></div><canvas class="xterm-text-layer" width="1507" height="184" style="z-index: 0; width: 1206px; height: 147px;"></canvas><canvas class="xterm-selection-layer" width="1507" height="184" style="z-index: 1; width: 1206px; height: 147px;"></canvas><canvas class="xterm-link-layer" width="1507" height="184" style="z-index: 2; width: 1206px; height: 147px;"></canvas><canvas class="xterm-cursor-layer" width="1507" height="184" style="z-index: 3; width: 1206px; height: 147px;"></canvas></div></div></div>
        ...
        <div id="tab-debug-console" class="tab-pane fade">
            ...
            <div class="split-pane-divider" id="my-divider2" style="left: 1228px;"><div class="split-pane-divider-inner"></div></div>
            <div class="split-pane-component" id="right-right-component" style="left: 1228px;">                
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" class="collapse-toggle" href="https://www.onlinegdb.com/online_c++_compiler#debug_window_call_stack">Call Stack</a>
      </h4>
    </div>
    <div id="debug_window_call_stack" class="collapse in">
        <div class="table-responsive"><div class="JCLRgrips" style="width: 156px;"><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.5px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" id="JColResizer1">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" class="collapse-toggle" href="https://www.onlinegdb.com/online_c++_compiler#debug_window_local_variables">Local Variables</a>
      </h4>
    </div>
    <div id="debug_window_local_variables" class="collapse in">
        <div class="table-responsive"><div class="JCLRgrips" style="width: 112px;"><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.5px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" id="JColResizer2">
...
<div class="panel panel-default panel-registers">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" class="collapse-toggle" href="https://www.onlinegdb.com/online_c++_compiler#debug_window_registers">Registers</a>
      </h4>
    </div>
...
<div class="panel panel-default panel-display-expression">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" class="collapse-toggle" href="https://www.onlinegdb.com/online_c++_compiler#debug_window_display_expression">Display Expressions</a>
      </h4>
    </div>
    <div id="debug_window_display_expression" class="collapse in">
    <div class="table-responsive">
        <div class="JCLRgrips" style="width: 146px;"><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.5px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" style="margin-bottom:0px" id="JColResizer0">
...
<div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" class="collapse-toggle" href="https://www.onlinegdb.com/online_c++_compiler#debug_window_breakpoints">Breakpoints and Watchpoints</a>
      </h4>
    </div>
    <div id="debug_window_breakpoints" class="collapse in">
        <div class="table-responsive"><div class="JCLRgrips" style="width: 139px;"><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.5px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.5px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" id="JColResizer3">
                    ...
                    <div class="omb_login">
                        <h3 class="omb_authTitle">Login with
                            ...
                            <div class="row omb_row-sm-offset-31 omb_socialButtons">
                                <div class="col-xs-4">
                                    <a href="https://www.onlinegdb.com/online_c++_compiler#" onclick="login(&#39;googleplus&#39;)" class="btn btn-lg btn-block omb_btn-google">
                                        <i class="fa fa-facebook visible-xs"></i>
                                        <span class="hidden-xs">Google+</span>
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="https://www.onlinegdb.com/online_c++_compiler#" onclick="login(&#39;facebook&#39;)" class="btn btn-lg btn-block omb_btn-facebook">
                                        <i class="fa fa-twitter visible-xs"></i>
                                        <span class="hidden-xs">Facebook</span>
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="https://www.onlinegdb.com/online_c++_compiler#" onclick="login(&#39;github&#39;)" class="btn btn-lg btn-block omb_btn-github">
...
-->
        <!-- Go to www.addthis.com/dashboard to customize your tools --> <script type="text/javascript" src="./1.2_files/addthis_widget.js.download"></script><iframe src="./1.2_files/container(1).html" style="visibility: hidden; display: none;"></iframe><div id="_atssh" style="visibility: hidden; height: 1px; width: 1px; position: absolute; top: -9999px; z-index: 100000;"><iframe id="_atssh642" title="AddThis utility frame" style="height: 1px; width: 1px; position: absolute; top: 0px; z-index: 100000; border: 0px; left: 0px;" src="./1.2_files/sh.f48a1a04fe8dbf021b4cda1d.html"></iframe></div><style id="service-icons-0"></style> 
...
<div id="criteoUserSyncTagsContainer" style="display: none;"><img src="./1.2_files/cri"><img src="./1.2_files/sync"></div><iframe id="adg-0-sync" height="0" width="0" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="./1.2_files/saved_resource.html" style="border: 0px; display: none;"></iframe><iframe id="google_osd_static_frame_3268357917645" name="google_osd_static_frame" style="display: none; width: 0px; height: 0px;" src="./1.2_files/saved_resource(1).html"></iframe><iframe src="./1.2_files/syncframe.html" id="criteo-syncframe-pbt" style="display: none;"></iframe><iframe src="./1.2_files/aframe.html" width="0" height="0" style="display: none;"></iframe><div class=" ace_editor ace_autocomplete ace_dark ace-idle-fingers" style="font-size: medium; top: 237px; height: 179.2px; left: 480.358px; display: none;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0;"></textarea><div class="ace_gutter" style="display: none;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px;"></div><div class="ace_gutter-active-line" style="display: none;"></div></div><div class="ace_scroller" style="left: 0px; right: 17px; bottom: 0px;"><div class="ace_content" style="cursor: default; margin-top: 0px; width: 261px; height: 224px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 707.76px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:22.399999618530273px;top:0px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line ace_selected" style="height:22.399999618530273px"><span class="ace_completion-highlight">H</span><span class="ace_">TML</span><span class="ace_rightAlignedText">local</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_completion-highlight">H</span><span class="ace_">askell</span><span class="ace_rightAlignedText">local</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_">mat</span><span class="ace_completion-highlight">h</span><span class="ace_rightAlignedText">local</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_">anyw</span><span class="ace_completion-highlight">h</span><span class="ace_">ere</span><span class="ace_rightAlignedText">local</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_">P</span><span class="ace_completion-highlight">H</span><span class="ace_">P</span><span class="ace_rightAlignedText">local</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_">Pyt</span><span class="ace_completion-highlight">h</span><span class="ace_">on</span><span class="ace_rightAlignedText">local</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_">t</span><span class="ace_completion-highlight">h</span><span class="ace_">row</span><span class="ace_rightAlignedText">keyword</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_">w</span><span class="ace_completion-highlight">h</span><span class="ace_">ile</span><span class="ace_rightAlignedText">keyword</span></div><div class="ace_line" style="height:22.399999618530273px"><span class="ace_">c</span><span class="ace_completion-highlight">h</span><span class="ace_">ar32_t</span><span class="ace_rightAlignedText">keyword</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors" style="opacity: 0;"><div class="ace_cursor" style="left: 4px; top: 0px; width: 8.797px; height: 22.4px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 22px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 380.8px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 0px; right: 17px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 261px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div></body><iframe sandbox="allow-scripts allow-same-origin" id="262932611b64b18" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./1.2_files/async_usersync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="2744bdd94843c" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./1.2_files/pd.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="2861f52c18f5453" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./1.2_files/saved_resource(2).html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="29c91bbbd8a6b86" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./1.2_files/usync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="302dd6ab0a70d11" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./1.2_files/sync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="31b43deca1e11c3" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./1.2_files/iframe.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="32c1e28cb0130f8" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./1.2_files/beacon.html">
    </iframe></html>